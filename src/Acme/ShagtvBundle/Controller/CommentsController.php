...
use Acme\ShagtvBundle\Form\CommentsType;
...
class CommentsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeShagtvBundle:Comments')->findAll();

        return $this->render('AcmeShagtvBundle:Comments:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AcmeShagtvBundle:Comments:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeShagtvBundle:Comments')->find($id);
        ...
        return $this->render('AcmeShagtvBundle:Comments:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AcmeShagtvBundle:Comments:edit.html.twig', array(
            'entity'      => $entity,
